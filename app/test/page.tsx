  ...
  return (
    <>
      <main>
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-28 lg:pb-24 lg:pt-32">
            <div className="relative z-10 mx-auto max-w-2xl text-center">
              <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">
                Marketing Tools for non Marketers
              </h1>
              <p className="mx-auto my-8 max-w-2xl text-xl">
                Efficiently manage your sales team with our innovative tools. Enhance productivity,
              ...
              <span className="mt-2 block text-center text-sm text-muted-foreground">For free</span>
            </div>
          </div>
            ...
            <div className="perspective-distant -mr-16 pl-16 lg:-mr-56 lg:pl-56">
              <div className="[transform:rotateX(20deg);]">
                <div className="lg:h-176 relative skew-x-[.36rad]">
                  <div
                    aria-hidden
                    className="bg-linear-to-b z-1 absolute -inset-16 from-background via-transparent to-background sm:-inset-32"
                  />
                  <div
                    aria-hidden
                    className="bg-linear-to-r z-1 absolute -inset-16 bg-white/50 from-background via-transparent to-background dark:bg-transparent sm:-inset-32"
                  />

                  <div
                    aria-hidden
                    className="absolute -inset-16 bg-[linear-gradient(to_right,var(--color-border)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-border)_1px,transparent_1px)] bg-[size:24px_24px] [--color-border:var(--color-zinc-400)] dark:[--color-border:color-mix(in_oklab,var(--color-white)_20%,transparent)] sm:-inset-32"
                  />
                  <div
                    aria-hidden
                    className="z-11 absolute inset-0 bg-gradient-to-l from-background"
                  />
                  <div
                    aria-hidden
          ...
          <div className="mx-auto max-w-5xl space-y-12 px-6 lg:px-0">
            ...
            <div className="relative rounded-3xl p-3 md:-mx-8 lg:col-span-3">
              <div className="aspect-88/36 relative">
                <div className="bg-linear-to-t z-1 absolute inset-0 from-background to-transparent" />
                <Image
        ...
        <section className="bg-zinc-50 py-12 dark:bg-zinc-900/50 md:py-20">
        ...
        <section className="bg-zinc-50 py-16 dark:bg-blue-600 md:py-32">
            ...
            <div className="mx-auto max-w-2xl">
              <blockquote>
                <p className="text-lg font-semibold sm:text-xl md:text-3xl">
                  ...
                  fusion of simplicity and versatility, enabling us to create UIs that are as
                ...
                <div className="mt-12 flex items-center gap-6">
                  ...
                  <div className="space-y-1 border-l pl-6">
                    ...
                    <span className="block text-sm text-muted-foreground">CEO, Nvidia</span>
                  </div>
                </div>
              </blockquote>
            </div>
        ...
        <section className="py-16 md:py-32">
          <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16 lg:px-0">
            <h2 className="relative z-10 max-w-xl text-4xl font-medium lg:text-5xl">
              APIs and platforms helping developers
            </h2>
            <div className="relative">
              <div className="relative z-10 space-y-4 md:w-1/2">
                <p className="text-body">
                  Lyra is evolving to be more than just the models.{" "}
                  <span className="text-title font-medium">It supports an entire ecosystem</span> —
                  from products innovate.
                </p>
                <p>
                  It supports an entire ecosystem — from products to the APIs and platforms helping
              ...
              <div className="mt-12 h-fit md:absolute md:-inset-y-12 md:inset-x-0 md:mt-0">
                <div
                  aria-hidden
                  className="bg-linear-to-l z-1 absolute inset-0 hidden from-transparent to-background to-55% md:block"
                />
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-rows-2">
                ...
                <CardContent>
                  <blockquote className="grid h-full grid-rows-[1fr_auto] gap-6">
                    <p className="text-xl font-medium">
                      ...
                      accelerated my workflow. The flexibility to customize every aspect allows me
                      to create unique user experiences. Tailus is a game-changer for modern web
                      development
                    </p>
              ...
              <Card className="md:col-span-2">
                <CardContent className="h-full pt-6">
                  <blockquote className="grid h-full grid-rows-[1fr_auto] gap-6">
                    <p className="text-xl font-medium">
                      Tailus is really extraordinary and very practical, no need to break your head.
                      A real gold mine.
                    </p>
