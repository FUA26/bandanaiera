  ...
  try {
    ...
    const systemSettings = await prisma.systemSettings.create({
      data: {
        ...
        siteDescription: "Platform terpadu untuk layanan publik dan informasi daerah Kabupaten Malang",
        siteSubtitle: "Portal Resmi Kabupaten Malang",
        minPasswordLength: 8,
        requireStrongPassword: false,
        citizenName: "Warga Kabupaten Malang",
        contactAddress: "Jalan Raden Panji No 158 Kepanjen, Kabupaten Malang, Jawa Timur 65163",
        contactEmails: ["sekda@malangkab.go.id"],
        contactPhones: ["(0341) 392024"],
        copyrightText: `© ${new Date().getFullYear()} Pemerintah Kabupaten Malang. Hak Cipta Dilindungi.`,
        socialFacebook: "https://facebook.com/malangkabupaten",
        socialInstagram: "https://instagram.com/malangkab.go.id",
        socialTwitter: "https://twitter.com/malangkab",
        socialYouTube: "https://youtube.com/@malangkab.go.id",
        versionNumber: "1.0.0",
      },
    });
