 ...
 *
 * Full-page form for creating a new service
 */
...
export function NewServiceClient({ categories }: NewServiceClientProps) {
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Lucide icon name (e.g., User, FileText, Settings)</p>
                  </div>
                </div>
